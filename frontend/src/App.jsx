          ...
          <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 mb-8 max-w-2xl mx-auto">
            <div className="flex flex-col sm:flex-row gap-3">
              <input 
                ...
                className="flex-grow px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition text-gray-700"
                value={videoUrl}
                onChange={(e) => setVideoUrl(e.target.value)}
              />
              <button className="bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-3 px-6 rounded-lg shadow transition duration-200 whitespace-nowrap">
                Analyze Video
              </button>
            </div>
          </div>
